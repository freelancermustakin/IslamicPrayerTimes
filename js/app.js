...
function error(error) {
	...
	// console.log(message);
	//document.getElementById("notification_message").innerHTML = "<strong>Warning!</strong> "+message+" Time showing according to <strong>Dhaka, Bangladesh</strong>"; //english
	document.getElementById("notification_message").innerHTML = "<strong>সতর্কতা!</strong> "+message+" <strong>ঢাকা, বাংলাদেশ</strong> সময় অনুযায়ী দেখছেন।"; //bangla
...
function showPrayTimes(lat, long, prayTimes) {
	...
	var listBN = ['ফজর', 'সূর্যোদয়', 'যোহর', 'আছর', 'সূর্যাস্ত', 'মাগরিব', 'এশা', 'মধ্যরাত'];
